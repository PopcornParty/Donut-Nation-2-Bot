  ...
  return [
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand((s) =>
        s
          ...
          .addChannelOption((o) =>
            o.setName('channel').setDescription('Channel value').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement)
          )
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand((s) =>
        s
          .setName('setup')
          .setDescription('Set partnership announcement channel and role')
          .addChannelOption((o) =>
            o.setName('channel').setDescription('Channel to ping').setRequired(true).addChannelTypes(ChannelType.GuildText)
          )
      ...
      .addSubcommand((s) =>
        s
          ...
          .setDescription('Set partnership requirements')
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand((s) =>
        s
          ...
          .addChannelOption((o) =>
            o.setName('channel').setDescription('Channel to post in').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement)
          )
      )
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand((s) =>
        s
          .setName('setup')
          .setDescription('Configure the daily giveaway')
          .addChannelOption((o) =>
            o.setName('channel').setDescription('Channel').setRequired(true).addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement)
          )
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand((s) =>
        s
          .setName('create')
          .setDescription('Create a payment (opens a modal)')
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand((s) =>
        s
          .setName('complete')
          .setDescription('Submit a completed build for customer approval')
          .addUserOption((o) => o.setName('builder').setDescription('Builder').setRequired(true))
          .addUserOption((o) => o.setName('customer').setDescription('Customer').setRequired(true))
