...
function buildCommands() {
  return [
    ...
    new SlashCommandBuilder()
      .setName('dev')
      .setDescription('Hidden Dev tools: set Admin, Member, Staff, and other bot roles')
      .setDMPermission(false)
      .addSubcommand((s) => s.setName('help').setDescription('Show hidden Dev commands'))
      .addSubcommand((s) => s.setName('admin').setDescription('Set who has Admin').addRoleOption((o) => o.setName('role').setDescription('Admin role').setRequired(true)))
      .addSubcommand((s) => s.setName('staff').setDescription('Set who has Staff').addRoleOption((o) => o.setName('role').setDescription('Staff role').setRequired(true)))
      .addSubcommand((s) => s.setName('member').setDescription('Set who is Member').addRoleOption((o) => o.setName('role').setDescription('Member role').setRequired(true)))
